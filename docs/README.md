...
- [Playback Engine](./Architecture/Playback.md)
- [Download Manager](./Architecture/DownloadManager.md)
- [Sync Manager](./Architecture/SyncManager.md)
- [Storage & Persistence](./Architecture/Storage.md)
- [PWA & Offline](./Architecture/PWA.md)

## Data Flow

User Interaction -> Redux Action -> Service/Manager -> Provider/Storage -> Redux State -> UI Update
