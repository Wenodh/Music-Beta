...
import { useMusicExplore } from '../hooks/useMusicExplore';
...
const MusicSection: React.FC<MusicSectionProps> = ({ language, columns }) => {
    const { items, loading, hasMore, loadMore, reset } = useMusicExplore(language);
