...
import { usePodcastExplore } from '../hooks/usePodcastExplore';
...
const PodcastSection: React.FC<PodcastSectionProps> = ({ language, columns }) => {
    const { items, loading, hasMore, loadMore, reset } = usePodcastExplore(language);
