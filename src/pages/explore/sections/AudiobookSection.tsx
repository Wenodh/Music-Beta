...
import { useAudiobookExplore } from '../hooks/useAudiobookExplore';
...
const AudiobookSection: React.FC<AudiobookSectionProps> = ({ language, columns }) => {
    const { items, loading, hasMore, loadMore, reset } = useAudiobookExplore(language);
    ...
    if (items.length === 0 && !loading) {
        return (
            <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <h2 className="text-xl font-semibold">No playable audiobooks found</h2>
...
export default React.memo(AudiobookSection);
