        ...
        <AnimatePresence>
            {currentSong && (
                <motion.div
                    ...
                    className={`dark:text-white fixed bottom-0 right-0 left-0 bg-white/80 backdrop-blur-lg border-t border-white/20 dark:border-gray-800/20 flex flex-col z-[210] overflow-hidden ${uiTheme?.isOled ? 'dark:bg-black/80' : 'dark:bg-gray-900/80'}`}
                >
