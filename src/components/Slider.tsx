...
const Slider: React.FC<SliderProps> = ({ data, title }) => {
    ...
    return (
        <div className="relative group mb-8">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 px-0 md:px-4">{title}</h2>
            <div className="relative">
                ...
                <div
                    ref={scrollRef}
                    className="flex overflow-x-auto gap-4 px-0 md:px-4 scrollbar-hide no-scrollbar"
